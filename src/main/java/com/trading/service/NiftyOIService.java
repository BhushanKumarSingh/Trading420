...
//			System.out.println(GREEN_BOLD + currentStrike);
			...
			for (Map<String, Object> data : dataList) {
				...
				int changeinOpenInterestCe =  (int)((Map<String, Object>) data.get("CE")).get("changeinOpenInterest");
				int changeinOpenInterestPe = (int) ((Map<String, Object>) data.get("PE")).get("changeinOpenInterest");
				int openInterestCe = (int) ((Map<String, Object>) data.get("CE")).get("openInterest");
				int openInterestPe = (int) ((Map<String, Object>) data.get("PE")).get("openInterest");
